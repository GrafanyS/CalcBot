...
#
# contact = r'phone_directory.json'
#
# def save(contacts_list): #метод сохранения как void в C#
#     with open(contact, "a", encoding="utf-8") as fh: # "w" это метод write
#         fh.write(json.dumps(contacts_list, ensure_ascii=False))  # fh это псевдоним
